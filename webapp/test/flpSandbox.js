					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Request Type Table",
									"targetURL": "#requesttype-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"requesttype-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=requesttype",
									"url": sap.ui.require.toUrl("requesttype")
								}
							}
						}
					}
